class Teacher {
    ...
    handleOnpress() {
        this.generateSecretWord.mousePressed(async () => {
            ...
            this.message.html("Send your secret word to your friend !");
        ...
        this.playButton.mousePressed(() => {
            ...
            this.greeting.html("Hello " + player.name + "Welcome to Avengers World");
            this.greeting.position(width / 2 - 200, height / 4);
